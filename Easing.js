// Easing.js — versione classica (no modules), espone window.Easing
(function () {
  'use strict';
  ...
  const Easing = {
    ...
    Sine: {
      // In = 1 - cos(πt/2), Out = sin(πt/2), InOut = 0.5*(1 - cos(πt))
    ...
    Elastic: {
      // Solo Out (come nel tuo codice); aggiungibili In / InOut se servono
